...
var wumaoPhrase2 = "說有什麼用？、誰當皇帝都一樣、這世界沒有絕對的公平、中國不能亂、美國也腐敗、能當飯吃嗎、這種事哪朝哪代都有、餓死人你看見了？、輪得到你來指指點點？、關你啥事？、中國太大了不好弄、總要有個過程、領導不比你笨、咱國家人太多了、你行你上啊、不喜歡你可以出國啊、離開祖國你什麼也不是、太平洋又沒有蓋、有國才有家、你幸福矚？".split("、")
wumaoPhrase.concat(wumaoPhrase2);
console.log(wumaoPhrase);
